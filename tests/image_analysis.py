...
for i, image in enumerate(images):
    ...
    try:
        ...
        print(
            f"Error decoding JSON for page {i+1}. Error: {str(e)}. Raw result: {result}"
        )
