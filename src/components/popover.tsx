...
const Popover = ({ isOpen: isOpenProp, setIsOpen: setIsOpenProp, children, position = 'down-center', ...props }) => {
    ...
    const contentClasses = `absolute transition-opacity duration-150 ease-out z-40 ${positionClasses[position]} ${isOpen ? 'pointer-events-auto opacity-100 scale-100' : 'pointer-events-none opacity-0'}`;
