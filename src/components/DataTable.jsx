  ...
  return (
    <div className="flex flex-col gap-3">
      ...
      <Card className="p-2 flex-row z-50 gap-3">
        ...
        {expenses.length > 0 && (
          <>
            <Button text="Save" handleClick={(e) => handleSave(tableRef)} imageSrc={SaveFileIcon} />
            <Button
      ...
      {expenses.length === 0 ? (
        <div className="flex justify-center items-center h-full">
          <h2 className="text-2xl font-medium text-neutral-950">No expenses found</h2>
        </div>
      ) : (
        <table ref={tableRef} className="border-separate border-spacing-px border bg-neutral-50 border-neutral-300 shadow-lg rounded-lg">
          <thead>
            <DataTableHeader
