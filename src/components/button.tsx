...
const Button = ({
  ...
  const buttonClass = clsx(
    'flex h-fit shadow whitespace-nowrap hover:opacity-70 justify-center flex-shrink-0 items-center gap-2 min-w-[120px] rounded transition-opacity duration-200 ease-linear',
  ...
  return (
    ...
    >
      {imageSrc && !isLoading && <Image width={16} height={16} src={imageSrc} alt={text} />}
      {isLoading && (
