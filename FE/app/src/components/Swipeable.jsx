...
const Swipeable = ({ visible, setVisible, closeDirection = 'right', closeTravel = 150, children, transition = 'transform 500ms cubic-bezier(0.32, 0.72, 0, 1)', ...props }) => {
    ...
    const handleMouseUp = useCallback(() => {
        ...
        dragTravel = 0;
    }, [closeTravel, transformToHide, transition, setVisible]);
