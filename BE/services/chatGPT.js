...
exports.formatDateAndGenerateCategory = async (dataItem, fileKey) => {
  ...
  try {
    ...
    // Update dataItem with formatted date and determined category
    dataItem.INVOICE_RECEIPT_DATE = { text: formattedDate, confidence: 100 };
    dataItem.CATEGORY = { text: category, confidence: 100 };
    dataItem.FILE_NAME = { text: fileKey, confidence: 100 };
